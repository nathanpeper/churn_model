...
def split_and_saved_data(config_path):
    ...
    split_ratio = config["interim_data_config"]["train_test_split_ratio"]
    random_state = config["interim_data_config"]["random_state"]
    interim_df=pd.read_csv(interim_data_path)
    split_data(interim_df,train_data_path,test_data_path,split_ratio,random_state)
